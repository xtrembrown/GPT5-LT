...
**Reccomended**: Watch this [video](https://www.youtube.com/watch?v=P1-KQZZarpc) by PyCon USA, from the keynote speaker _Simon Willison_; for a explanation on how Generative Pre-trained Transformer Models operate, specifically Large Language Models (LLM). 
